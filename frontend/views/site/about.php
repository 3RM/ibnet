...
<div class="site-about">
    <div class="row">
        <div class="col-md-8">
            ...
            <h2>The Present</h2>
            <p><?= HTML::img('@web/images/Steve&Dave.jpg', ['class' => 'img-rounded', 'align' => 'left', 'style' => 'margin-right: 10pt']) ?><?= HTML::a('Steve McKinley', ['profile/missionary', 'urlLoc' => 'ireland', 'name' => 'mckinley', 'id' => 1], ['target' => '_blank']) ?> is a missionary to the Republic of Ireland and a friend of Dr. Capetz.  He too understood the need and the great potential for an online marketplace for independent Baptists.  He took up the mantle of Dr. Captetz’ work, and relaunched IBNet in 2017.<br><br><br><br></p>
