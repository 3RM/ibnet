    ...
    <div class="row top-margin-md">
        <div class="col-md-6">
            <div class="embed-responsive embed-responsive-16by9">
                <iframe src="https://player.vimeo.com/video/209344791?color=ffffff&title=0&byline=0&portrait=0" width="500" height="266" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
         </div>
        <div class="col-md-6" style="padding: 0 40px">
            <h2>Learn how to create a church profile</h2>
            <p>This video will show you how to create a church profile.  The church profile is representative of all organization profiles, so if you plan to create any organization profile, this is the place to start.  In preparation, it is helpful to have ready a church description and two pictures, one large (minimum 1200x315 pixels) and one small (minimum 370x280 pixels), both with a maximum file size of 4MB.   The forms are self-explanatory, but this how-to-video will let you see in advance the steps necessary to create your profile.</p>
        </div>
    </div>
