...
<div class="profile">
	...
	<?php } elseif ($p == 'connections') { ?>
		<div class="additional-content">
			<?= $this->render('connection/_' . ProfileController::$profilePageArray[$profile->type] . 'Connections', ['profile' => $profile, 'parentMinistry' => $parentMinistry, 'staffArray' => $staffArray, 'missionaryArray' => $missionaryArray, 'programChurchArray' => $programChurchArray, 'parentMinistry' => $parentMinistry, 'likeArray' => $likeArray]); ?>
		</div>
