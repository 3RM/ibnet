...
<div class="profile">
	<div class="profile-main">
		...
		<?= $this->render('cards/_card-staff', ['profile' => $profile, 'church' => $church, 'parentMinistry' => $parentMinistry]) ?>
	...
	<?php } elseif ($p == 'connections') { ?>
		<div class="additional-content">
			<?= $this->render('connection/_' . ProfileController::$profilePageArray[$profile->type] . 'Connections', ['profile' => $profile, 'church' => $church, 'parentMinistry' => $parentMinistry, 'otherMinistryArray' => $otherMinistryArray, 'sChurchArray' => $sChurchArray, 'sMinistryArray' => $sMinistryArray, 'sOtherArray' => $sOtherArray, 'pastor' => $pastor, 'memberArray' => $memberArray, 'likeArray' => $likeArray]); ?>
		</div>
