	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 profile-thirds">
				...
				<?php if (isset($social)) { ?>
					<p><?= empty($social->sermonaudio) ? NULL : HTML::a('SermonAudio', $social->sermonaudio, ['target' => 'blank']) . '<br>' ?>
					...
					<?= empty($social->flickr) ? NULL : HTML::a('Flickr', $social->flickr, ['target' => 'blank']) . '<br>' ?></p>		
				<?php } ?>
				<!-- Εnd Social -->
			...
			<div class="col-md-4 profile-thirds">
				...
				<p><strong>Home Church: </strong><br>
					<?= $church ? HTML::a($churchLink, ['/profile/church', 'id' => $church->id, 'city' => $church->url_city, 'name' => $church->url_name]) . '<br>' : '<br>' ?>
				</p>
				<!-- End Home Church -->
				<br>
				<!-- Last Update -->
