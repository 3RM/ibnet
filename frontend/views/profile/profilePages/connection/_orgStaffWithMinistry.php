		...
		echo '<div class="connection-container">';
			echo '<div class="connection">';
				...
				echo '<div class="title">';
					...
					echo Html::tag('span', '<br>' . $stf->staff_title . ' at ' . 
						Html::a($ministry->org_name . '&nbsp' . Html::icon('link', ['class' => 'internal-link']), [ProfileController::$profilePageArray[$ministry->type], 'urlLoc' => $ministry->url_loc, 'urlName' => $ministry->url_name, 'id' => $ministry->id]), 
						['class' => 'subTitle']);
				echo '</div>';
			echo '</div>';
		echo '</div>';
