    ...
    <div class="row">
        ...
        <div class="col-md-3 boxes">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <?= isset($l) ?
                        '<div class="sort"><p>Answer Date </p><p>' . Html::a(Html::icon('arrow-up'), Url::current(['f' => $f, 'l' => $l, 'sort' => 'answer_date'])) . ' ' . Html::a(Html::icon('arrow-down'), Url::current(['sort' => '-answer_date'])) . '</p></div>' :
                        '<div class="sort"><p>Most Recent </p><p>' . Html::a(Html::icon('arrow-up'), Url::current(['f' => $f, 'l' => $l, 'sort' => 'last_update'])) . ' ' . Html::a(Html::icon('arrow-down'), Url::current(['sort' => '-last_update'])) . '</p></div>'; ?>
                    <div class="sort"><p>Requested By </p><p><?= Html::a(Html::icon('arrow-up'), Url::current(['f' => $f, 'l' => $l, 'sort' => 'name'])) . ' ' . Html::a(Html::icon('arrow-down'), Url::current(['sort' => '-name'])) ?></p></div>
                    <div class="sort"><p>Duration </p><p><?= Html::a(Html::icon('arrow-up'), Url::current(['f' => $f, 'l' => $l, 'sort' => 'duration'])) . ' ' . Html::a(Html::icon('arrow-down'), Url::current(['sort' => '-duration'])) ?></p></div>
                </div>
            <!-- /sort box -->
            </div>
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    "$('#name-id').change(function () {
                        ...
                        window.location.replace('" . Url::to(['network/prayer', 'id' => $network->id, 'f' => $f, 'l' => $l]) . "' + nameVal);
                    ...
                    "$('#duration-id').change(function () {
                        ...
                        window.location.replace('" . Url::to(['network/prayer', 'id' => $network->id, 'f' => $f, 'l' => $l]) . "' + durVal);
                    });", \yii\web\View::POS_READY); ?>
                    ...
                    "$('#tag-id').change(function () {
                        ...
                        window.location.replace('" . Url::to(['network/prayer', 'id' => $network->id, 'f' => $f, 'l' => $l]) . "' + tagVal);
                    });", \yii\web\View::POS_READY); ?>
                    <div class="reset">
                        <?= Html::a('<span class="glyphicons glyphicons-repeat"></span>', Url::to(['network/prayer', 'id' => $network->id, 'l' => $l]), ['data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Reset List']) ?>
                        <?= Html::a('<span class="glyphicons glyphicons-resize-full"></span>', Url::to(['network/prayer', 'id' => $network->id, 'f' => 1, 'l' => $l]), ['data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Show Entire List']) ?>
                    </div>
                </div>
            <!-- /filter box -->
            </div>
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <?php Modal::begin([
                        ...
                        <p>
                            Send requests to: <?= $network->prayer_email ? '<b>' . $network->prayer_email . '</b>' : '<i>Pending</i>' ?><br>
                   ...
                   <?php Modal::begin([
                        ...
                        <div class="export-container">
                            <div class="export-controls">
                                ...
                                <?= Html::button('Export', ['id' => 'export-btn-id', 'class' => 'btn btn-primary']); ?>
                            </div>
                        </div>
                        <div class="page">
                            <div id="loading-id" style="display:none">Working on it...</div>
                            <p style="margin:0; font-size:24px;"><?= $network->name ?> Prayer List</p>
                    ...
                    "$('#export-btn-id').click(function () {
                        ...
                        $.post('" . Yii::$app->urlManager->createAbsoluteUrl(['network/prayer', 'id' => $network->id]) . "', 
        ...
        <div class="col-md-9 prayer-list">
            <?= ListView::widget([
                ...
                'showOnEmpty' => false,
                'emptyText' => '
                    <div class="col-md-9 list-empty">
                      <div class="switch-view">' . Html::a(isset($l) ? 'View Prayer List' : 'View Answer List', ['network/prayer', 'id' => $network->id, 'l' => !$l]) . '</div>
                      <h3><em>... no requests</em></h3>
                    </div>',
                'itemView' => $l ? '_answerItem' : '_prayerItem',
                'itemOptions' => ['class' => 'item-bordered'],
                'viewParams'=>['nmid'=>$member->id],
                'layout' => '<div class="summary-row hidden-print clearfix">{summary}<div class="switch-view">' . Html::a(isset($l) ? 'View Prayer List' : 'View Answer List', ['network/prayer', 'id' => $network->id, 'l' => !$l]) . '</div></div>{items}{pager}',
            ]); ?>
        </div>
        <!-- /prayer list -->
