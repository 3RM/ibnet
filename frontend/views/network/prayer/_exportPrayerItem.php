...
<?php 
    if ($index < 9) {
        $cols = 'single';
        echo '<div style="margin:10px 0 0 12px; height:auto; overflow:hidden;">';
    } elseif ($index < 99) {
        $cols = 'double';
        echo '<div style="margin:10px 0 0 6px; height:auto; overflow:hidden;">';
    }  else {
        $cols = 'triple';
        echo '<div style="margin:10px 0 0 0; height:auto; overflow:hidden;">';
    }
?>
    ...
    <div style="overflow:hidden;">
        ...
        <div class="details">
            <?= $model->description ? '<div class="description ' . $cols .'">' . $model->description . '</div>' : NULL; ?>
