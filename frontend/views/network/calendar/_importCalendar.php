...
<div>
    ...
    <p>
        Or, add holidays for any country using a url from here: <?= Html::a('https://www.officeholidays.com/ics/', 'https://www.officeholidays.com/ics/', ['target' => '_blank', 'rel' => 'noopener noreferrer']) ?>
    </p>

    <?php $form = ActiveForm::begin(['action' => '/network/remove-ical']); ?>
