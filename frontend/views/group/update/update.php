        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                "$('#name-id').change(function () {
                    ...
                    window.location.replace('" . Url::to(['group/update', 'id' => $group->id]) . "' + nameVal);
                });", \yii\web\View::POS_READY); ?>
                <div class="reset">
                    <?= Html::a('<span class="glyphicons glyphicons-repeat">', Url::to(['group/update', 'id' => $group->id]), ['data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Reset List']) ?>
                </div>
            </div>
        <!-- /filter box -->
        </div>
