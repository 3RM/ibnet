...
<div class="profile">
	<div class="profile-main">
		...
		<?= (empty($parentMinistry) || empty($parentMinistryLink)) ? NULL : $this->render('../profile/profilePages/cards/_card-parentministry', ['profile' => $profile, 'parentMinistry' => $parentMinistry, 'parentMinistryLink' => $parentMinistryLink]) ?>
		<?= empty($schoolLevel) ? NULL : $this->render('../profile/profilePages/cards/_card-schoollevels', ['schoolLevel' => $schoolLevel]) ?>
		<?= empty($accreditations) ? NULL : $this->render('../profile/profilePages/cards/_card-accreditations', ['accreditations' => $accreditations]) ?>
