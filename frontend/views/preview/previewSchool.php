	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 profile-thirds">
				...
				<strong>School Levels Offered:</strong><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['sl']-1, 'id' => $profile->id, 'e' => 1]) ?></span><br>
			...
			<div class="col-md-4 profile-thirds">
				...
				<strong>Ministry of:</strong><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['pm']-1, 'id' => $profile->id, 'e' => 1]) ?></span><br>
				...
				<strong>Accreditations:</strong><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['as']-1, 'id' => $profile->id, 'e' => 1]) ?></span><br>
