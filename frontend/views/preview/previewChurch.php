	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 profile-thirds">
				...
				<strong>Service Times:</strong><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['st']-1, 'id' => $profile->id]) ?></span><br>
			...
			<div class="col-md-4 profile-thirds">
				...
				<strong>Programs: </strong> <span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['pg']-1, 'id' => $profile->id]) ?></span><br>
				<?php if ($programs) {
