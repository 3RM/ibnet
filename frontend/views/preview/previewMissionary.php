	...
	<div class="container">
		...
		<div class="row description">
			...
			<div class="col-md-8">
					...
					<h4><?= '<span  class="edit">' . Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['fi']-1, 'id' => $profile->id, 'e' => 1]) . '</span>' ?> 
		...
		<div class="row">
			...
			<div class="col-md-4 profile-thirds">
				...
				<strong>Schools Attended: </strong><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['sa']-1, 'id' => $profile->id, 'e' => 1]) ?></span><br />
			...
			<div class="col-md-4 profile-thirds">
				...
				<strong>Field: </strong>
				<?php if ($profile->sub_type == 'Furlough Replacement') { ?>
					<?= $missionary->field == 'Furlough Replacement' ? 'Various' : $missionary->field ?><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['/profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['fi']-1, 'id' => $profile->id, 'e' => 1]) ?></span>
				<?php } elseif ($profile->sub_type == 'Bible Translator') { ?>
					<?= $missionary->field ?><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['/profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['fi']-1, 'id' => $profile->id, 'e' => 1]) ?></span>
				<?php } else { ?>
					<?= $missionary->field ?><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['/profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['fi']-1, 'id' => $profile->id, 'e' => 1]) ?></span>
				<?php } ?><br>
				...
				<strong>Sending Church: </strong><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['/profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['hc']-1, 'id' => $profile->id, 'e' => 1]) ?></span><br>
				<?php echo $churchLink ?
				...
				<strong>Mission Agency: </strong><span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['/profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['ma']-1, 'id' => $profile->id, 'e' => 1]) ?></span><br>
				<?= empty($missionLink) ?
			    	$mission->mission : 
				...
				<span  class="pull-right edit"><?= Html::a(Html::icon('edit'), ['profile-form/form-route', 'type' => $profile->type, 'fmNum' => ProfileFormController::$form['cp']-1, 'id' => $profile->id, 'e' => 1]) ?></span>
				<br>
				<!-- Last Update -->
