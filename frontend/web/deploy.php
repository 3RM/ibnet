 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'git@github.com:mcki0127/ibnet.git');
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/var/www/vhosts/ibnet.org/httpdocs/');
 ...
 * @var string Full path including the trailing slash
 */
if (!defined('TMP_DIR')) define('TMP_DIR', '/var/www/vhosts/ibnet.org/tmp/spgd-ibnet-'.md5(REMOTE_REPOSITORY).'/');
