 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'HD$937DFJ$fhNz');
 ...
 */
define('TARGET_DIR', '/var/www/vhosts/ibnet.org/httpdocs/');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/var/www/vhosts/ibnet.org/tmp/spgd-ibnet-'.md5(REMOTE_REPOSITORY).'/');
