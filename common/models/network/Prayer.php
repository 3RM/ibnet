...
use common\models\network\NetworkMember; use common\models\Utility;
use common\models\network\PrayerTag;
...
class Prayer extends \yii\db\ActiveRecord
{
    ...
    public function scenarios() {
        return[
            'prayer' => ['request', 'description', 'duration', 'network_id', 'network_member_id', 'select'],
            'update' => [],
    ...
    public function rules()
    {
        return [
            ...
            [['network_id', 'network_member_id', 'select'], 'safe', 'on' => 'prayer'],
